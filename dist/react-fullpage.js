...
var slidesContainSameContent=slideContent.length>0&&slideContent.length===newSlideContent.length&&slideContent.every(function(value,index){return value===newSlideContent[index];});if(sectionCount===newSectionCount&&slideCount===newSlideCount&&slidesContainSameContent){return;}// NOTE: if sections/slides have changed we need to rebuild
